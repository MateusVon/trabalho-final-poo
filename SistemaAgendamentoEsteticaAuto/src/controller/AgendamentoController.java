...
public class AgendamentoController {
    ...
    public void verificaAgendamento(Cliente cliente,Veiculo veiculo,TiposDeServicos tipoServico, String dataStr,String horaStr,FormaPagamento forma) throws AgendamentoException{

        // Converte a data e hora recebidas do usuário pela interface do formato String para LocalDate/LocalTime
        ...
        double percentual = veiculo.calcularPrecoEspecifico(); // Serve para resgatar o percentual que será aplicado na criação do preço do serviço.
