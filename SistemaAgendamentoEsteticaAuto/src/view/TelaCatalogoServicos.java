...
public class TelaCatalogoServicos extends JFrame {
    ...
    public TelaCatalogoServicos() {
        ...
        tabelaServicos.setFillsViewportHeight(false); // Impede que a tabela estique as linhas vazias quando serviçso são ocultados em relação a categoria do veículo.
        JScrollPane scrollTabela = new JScrollPane(tabelaServicos); // Coloca a tabela de serviços em um espaço de rolagem do scroll do mouse do usuário.
        scrollTabela.setBorder(javax.swing.BorderFactory.createEmptyBorder()); // retira a borda da tabela onde ficariam as linhas vazias.
        scrollTabela.setBounds(50, 110, 600, 180); // Define as medidas da tabela de serviços na janela.
        scrollTabela.getViewport().setBackground(Color.decode("#34495e")); // Coloca a cor azul escuro onde ficariam as linhas vazias.
