...
public enum TiposDeServicos {
  // Serviços gerais (Aplicados a qualquer categoria de veículo, exceto insulfim que não se aplica a motos).
  ...
  // Ao declarar uma constante Enum com false/true, está sendo chamado o construtor implicitamente para atribuir o valor do atributo
  // "exclusivoTransporte", sendo este valor imutável pelo usuário devido o atributo ser declarado como final.
