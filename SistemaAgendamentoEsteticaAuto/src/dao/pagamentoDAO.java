    ...
    public List<Pagamento> listar() {
        ...
        for(String linha : linhas){ // Loop para percorrer linha por linha para converter
            ...
            try{
                ...
                System.err.println("Erro ao ler linha do pagamento: " + linha); // Avisar se a linha está corrompida sem travar o sistema
            }
        }
...
public static void main(String[] args) {
    ...
    System.out.println("Alterando pagamento " + pagamento1.getId() + " para CANCELADO...");
    ...
    System.out.println("\n--- 6. LISTAGEM FINAL (O ID " + idParaDeletar + " deve ter sumido) ---");
    ...
    if (pEncontrado != null) {
        ...
        System.out.println("Pagamento com ID " + pEncontrado.getId() + " não existe.");
    }
    */
}
